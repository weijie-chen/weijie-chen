...
| Project | Content |
|---------|----------|
| [Stochastic Atlas](https://stochastic-atlas.vercel.app/) | Visualization-driven exploration of theoretical quantitative finance models, integrating geometric intuition with formal mathematical derivations. |
